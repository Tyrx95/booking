...
define("ember-paypal-button/test-support/mock", ["exports"], function (exports) {
  ...
  function mock() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        window = _ref$window === undefined ? window : _ref$window,
  ...
  function reset(_ref2) {
    var _ref2$window = _ref2.window,
        window = _ref2$window === undefined ? window : _ref2$window;
...
define('ember-window-mock/-private/mock/location', ['exports'], function (exports) {
  ...
  function locationFactory(defaultUrl) {
    ...
    mappedPorperties.forEach(function (propertyName) {
      ...
      set: function set(value) {
        try {
          ...
          if (value.charAt(0) === '/') {
            ...
            var parts = url.pathname.split('/').filter(function (item, index, array) {
    ...
    var proxy = new Proxy(original, {
      get: function get(target, name) {
        ...
        if (_typeof(target[name]) === 'object') {
          var _proxy = proxyFactory(target[name]);
          holder[name] = _proxy;
          return _proxy;
        }
        return target[name];
...
define("ember-window-mock/-private/window", ["exports", "ember-window-mock/-private/mock/location", "ember-window-mock/-private/mock/local-storage", "ember-window-mock/-private/mock/proxy"], function (exports, _emberWindowMockPrivateMockLocation, _emberWindowMockPrivateMockLocalStorage, _emberWindowMockPrivateMockProxy) {
  "use strict";
  ...
  var location = (0, _emberWindowMockPrivateMockLocation["default"])(originalWindow.location.href);
  var localStorage = new _emberWindowMockPrivateMockLocalStorage["default"]();
  var holder = {};
    ...
    get: function get(target, name) {
      switch (name) {
        ...
        default:
          ...
          if (_typeof(window[name]) === 'object') {
            var proxy = (0, _emberWindowMockPrivateMockProxy["default"])(window[name]);
            holder[name] = proxy;
            return proxy;
          }
          return target[name];
  ...
  function reset() {
    location = (0, _emberWindowMockPrivateMockLocation["default"])(originalWindow.location.href);
    localStorage = new _emberWindowMockPrivateMockLocalStorage["default"]();
    holder = {};
  }
});
define('ember-window-mock/index', ['exports', 'ember-window-mock/-private/window'], function (exports, _emberWindowMockPrivateWindow) {
  'use strict';

  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _emberWindowMockPrivateWindow['default'];
    }
  });
  Object.defineProperty(exports, 'reset', {
    enumerable: true,
    get: function get() {
      return _emberWindowMockPrivateWindow.reset;
    }
  });
});
